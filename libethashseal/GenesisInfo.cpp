...
#include "genesis/tripMainNetwork.cpp"
#include "genesis/tripTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::tripMainNetwork: return c_genesisInfoTripMainNetwork;
	case Network::tripTestNetwork: return c_genesisInfoTripTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::tripMainNetwork: return c_genesisStateRootTripMainNetwork;
	case Network::tripTestNetwork: return c_genesisStateRootTripTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
